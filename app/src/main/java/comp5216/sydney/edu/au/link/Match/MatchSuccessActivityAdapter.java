...
public class MatchSuccessActivityAdapter extends ArrayAdapter<MatchPerson> {
    ...
    public MatchSuccessActivityAdapter(Context context, List<MatchPerson> items, OnDeleteRequestListener deleteListener) {
